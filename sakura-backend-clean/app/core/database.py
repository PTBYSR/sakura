...
class DatabaseManager:
    ...
    def __init__(self, settings: Settings):
        ...
        # Use MONGO_URI (matching original backend)
    ...
    async def connect(self) -> None:
        ...
        for attempt in range(max_retries):
            try:
                ...
                self.db = self.client.sakura  # Use 'sakura' as default database name
...
def get_database():
    ...
    if db_manager is None or db_manager.db is None:
        # Return None instead of raising exception for optional database
        return None
